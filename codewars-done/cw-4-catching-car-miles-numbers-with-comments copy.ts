...
function isInteresting(n: number, awesomePhrases: number[]): number {
    ...
    function isInterestingCurrentNuber(n2: number): number {
        ...
        // console.log(n, strArr, strArr.every((currentValue: string) => currentValue === strArr[0]));
        ...
        for (let index = 0; index < digits.length - 1; index++) {
            ...
            // console.log(`digits[${index+1}]=`, index+1);
    ...
    // console.log(1, n, isInterestingCurrentNuber(n));
    if (isInterestingCurrentNuber(n) === 2) return 2;
    // console.log(2, n + 1, isInterestingCurrentNuber(n + 1));
    if (isInterestingCurrentNuber(n + 1) === 2) return 1;
    // console.log(3, n + 2, isInterestingCurrentNuber(n + 2));
